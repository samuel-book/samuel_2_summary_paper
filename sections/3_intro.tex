...
\begin{enumerate}
    ...
    \item \textbf{Investigate how well organisation factors (from the SSNAP organisational audit) predict thrombolysis use.}

    \item \textbf{Generation of a web-based dashboard} to allow clinicians to interrogate modelling.

    \item \textbf{Generation of synthetic data and artificial patient vignettes (virtual patients)} for enhanced sharing of the modelling (sharing working code with data).
