...
% Paper order changed back. The original order first etsablished thrmbolysis works as expected, then goes on to analyse who is receivnig it. So paper 3 (clinical trial) supoports paper 4 (rather than vice versa).
